...
// Tidak ada import yang diperlukan karena tidak ada ikon di sini
            ...
            <div className="relative z-10 flex items-center justify-center h-full text-center text-white p-4">
                <div className="max-w-4xl mx-auto space-y-4">
                    ...
                    <p className="text-base font-light text-gray-200 max-w-2xl mx-auto">
                        Jelajahi kumpulan karya terbaik kami. Setiap foto dan video di sini adalah bukti komitmen kami terhadap kualitas sinematik dan penceritaan emosional.
                    </p>
